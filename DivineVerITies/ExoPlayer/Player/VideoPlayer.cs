...
using Audio = Com.Google.Android.Exoplayer.Audio;
...
namespace DivineVerITies.ExoPlayer.Player
{
    ...
    /// </summary>
    class VideoPlayer : Object, IExoPlayerListener, ChunkSampleSource.IEventListener,
        ...
        MetadataTrackRenderer.IMetadataRenderer, DebugTextViewHelper.IProvider
    {
        ...
        public const int StateIdle = Exoplayer1.StateIdle;
        public const int StatePreparing = Exoplayer1.StatePreparing;
        public const int StateBuffering = Exoplayer1.StateBuffering;
        public const int StateReady = Exoplayer1.StateReady;
        public const int StateEnded = Exoplayer1.StateEnded;
        public const int TrackDisabled = Exoplayer1.TrackDisabled;
        public const int TrackDefault = Exoplayer1.TrackDefault;
